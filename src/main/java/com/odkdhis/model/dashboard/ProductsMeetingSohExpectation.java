 ...
 * @author Paul Omboi
 */
public class ProductsMeetingSohExpectation {
    ...
    public ProductsMeetingSohExpectation() {
    }

    public ProductsMeetingSohExpectation(String Product_name, int expected_yes, int expected_no, int total_expected) {
