 ...
 * @author Paul Omboi
 */
public class FacilitiesWithMatchingData {
    ...
    public FacilitiesWithMatchingData(){
    }

    public FacilitiesWithMatchingData(String county, String product_name, int allfacilities, int matching, int notmatching) {
        this.county = county;
